 ...
 *          insert();
 * @version 0.6 Mar 18, Implementación de interfaz Aliasable<T>
 * @version 0.7 Mar 21, Implementación de interfaz Updatable
 * @version 0.8 Mar 29, Se implementó el método setName(String)
 * @param <T>
 */
